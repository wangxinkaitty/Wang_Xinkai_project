...
performed using *fMRIPrep* 25.1.1
...
non-uniformity (INU) with `N4BiasFieldCorrection` [@n4], distributed with ANTs 2.6.0
...
nonlinear registration with `antsRegistration` (ANTs 2.6.0),
